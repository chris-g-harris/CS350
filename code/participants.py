...
def main():
    ...
    people = ["Christopher Harris", "Evan Minor", "Devin Panikkar", "Lauren Simms", "Fernando Espinoza", "Vandiver David", "Matthew Bradow","Mandeep Singh","Edgar Diaz", "James Butts", "Ashley Carlson", "<your name here>"]
